                        ...
                        <div class="grid grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select name="department"
                                    ...
                                    <option value="Hotel" <?= ($employee['department'] ?? '') == 'Hotel' ? 'selected' : '' ?>>
                                        Hotel</option>
                                    ...
                                    <option value="Logistic" <?= ($employee['department'] ?? '') == 'Finance' ? 'selected' : '' ?>>Finance</option>
                                </select>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <select name="status"
                                    class="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    <option value="Fired" <?= ($employee['status'] ?? '') == 'Fired' ? 'selected' : '' ?>>Fired
                                    </option>
                                    <option value="Probationary" <?= ($employee['status'] ?? '') == 'Probationary' ? 'selected' : '' ?>>Probationary</option>
                                    <option value="Regular" <?= ($employee['status'] ?? '') == 'Regular' ? 'selected' : '' ?>>
                                        Regular</option>
                            ...
                            <div>
                                ...
                                <select name="role"
                                    ...
                                    <option value="employee" <?= ($employee['role'] ?? '') == 'employee' ? 'selected' : '' ?>>
                                        Employee</option>
                                    <option value="mentor" <?= ($employee['role'] ?? '') == 'mentor' ? 'selected' : '' ?>>
                                        Mentor</option>
                    ...
                    <?php if (!empty($employee['applicant_experience']) || !empty($employee['applicant_education'])): ?>
                        <div class="mb-6">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    <label class="block text-xs text-gray-500 mb-1">Resume Path</label>
                                    <div class="flex gap-2">
                                        <?php
                                        $resumePath = $employee['applicant_resume_path'] ?? '';
                                        if (!empty($resumePath)):
                                            ...
                                            elseif (in_array($extension, ['jpg', 'jpeg', 'png']))
                                                $icon = 'fa-file-image';
                                            ?>
                                            <a href="<?= htmlspecialchars($resumePath) ?>" target="_blank"
                                                class="inline-flex items-center gap-2 px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors duration-200"
                                                download="<?= htmlspecialchars($resumePath) ?>">
                                                <i class="fas <?= $icon ?> text-gray-600"></i>
                                                <span class="text-sm text-gray-700">View Resume
